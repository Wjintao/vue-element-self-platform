    ...
    <div>
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form :model="ruleForm" class="demo-ruleForm" :rules="rules" ref="ruleForm" label-position="top"
          ...
          <el-col :span="1" style="text-align:center;margin: 5px 50px 0">————————</el-col>
          <el-col :span="4">
          ...
          <el-button @click.native.prevent="" class="but-group" style="margin:0 30px" type="primary">查询</el-button>
          <a href="javascript:void(0)" v-show="showCommentInput" @click="handleNextStep(showCommentInput,1)">按旧版形式查看</a>
          <a href="javascript:void(0)" v-show="!showCommentInput"
             @click="handleNextStep(showCommentInput,2)">按新版形式查看</a>
        </el-form>
      </el-col>
    </div>
    </br>
  ...
  export default {
    ...
    methods: {
      handleNextStep: function (showCommentInput, page) {
        ...
        this.$router.push('/activePublic/step' + page);
        var _this = this;
      },
      goStep: function (n) {
        switch (n) {
