<template>
  <div id="app">
    ...
    <main>
          <!-- 左侧导航 -->
        <div class="main-left">
          <el-menu default-active="/annualLeaveView" class="el-menu-vertical-demo" :router="true">
            <el-menu-item index="/annualLeaveView" :class="{'isActive': active}">休假查询</el-menu-item>
            <el-menu-item index="/wagesView" :class="{'isActive': active1}">工资考勤明细</el-menu-item>
            <el-menu-item index="/socialSecurity" :class="{'isActive': active2}">社会保险查询</el-menu-item>
            <el-menu-item index="/gjjQuery" :class="{'isActive': active3}">住房公积金查询</el-menu-item>
            <el-menu-item index="/empModifyPW" :class="{'isActive': active4}">员工自助服务密码修改</el-menu-item>
            <el-menu-item index="/empSelfMana" :class="{'isActive': active5}">员工自助平台后台管理</el-menu-item>
          </el-menu>
        </div>
...
export default {
  ...
  created: function(){
    this.$router.push('/annualLeaveView');
  },
  methods: {
