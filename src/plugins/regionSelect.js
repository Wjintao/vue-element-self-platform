...
export const RegionSelect = ($element, option) => {
  ...
  Address.prototype = {
    ...
    addElement: function (opts) {
      ...
      html += '<div class="rs-header"><ul class="clearfix addr-tabs"><li class="fl tabs tabs-province" data-id="province"><span class="">请选择</span></li> <li class="fl tabs tabs-city" data-id="city" style="display: none;"><span class="">请选择</span></li> <li class="fl tabs tabs-county" data-id="county" style="display: none;"><span class="">请选择</span></li> <li class="shut-down fr" style="display: none;">完成</li> </ul> </div>'
   ...
   // 添加插件样式
    ...
    close: function (result) {
      ...
      $('#rs-mask').click()
      this.resetStyle(id)
      result && this.settings.complete(result)
    },
     // 加载地址数据
    loadAddressData: function (type, parentCode) {
      ...
      getProvince({data: data}).then((data) => {
